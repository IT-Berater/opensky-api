...
/**
 * Represents the State of a vehicle as seen by the network at a particular
 * time.
 *
...
public class StateVector implements Serializable {
	...
	if (icao24 == null)
	    throw new RuntimeException("Invalid icao24. Must not be null");
	this.icao24 = icao24;
	this.serials = null;
    }
    ...
    /**
     * @return longitude in ellipsoidal coordinates (WGS-84) and degrees. Can be
     *         {@code null}
     */
    ...
    /**
     * @return latitude in ellipsoidal coordinates (WGS-84) and degrees. Can be
     *         {@code null}
     */
    ...
    /**
     * @return in decimal degrees (0 is north). Can be {@code null} if information
     *         not present
     */
    ...
    /**
     * @return in m/s, incline is positive, decline negative. Can be {@code null} if
    ...
    /**
     * @return callsign of the vehicle. Can be {@code null} if no callsign has been
     *         received.
     */
    ...
    /**
     * @return seconds since epoch of last message overall received by this
     *         transponder.
     */
    ...
    /**
     * @return seconds since epoch of last position report. Can be {@code null} if
     *         there was no position report received by OpenSky within 15s before.
     */
    ...
    /**
     * @return serial numbers of sensors which received messages from the vehicle
     *         within the validity period of this state vector. {@code null} if
     *         information is not present, i.e., there was no filter for a sensor in
     *         the request
     */
	...
	return "StateVector{" + "geoAltitude=" + geoAltitude + ", longitude=" + longitude + ", latitude=" + latitude
		+ ", velocity=" + velocity + ", heading=" + heading + ", verticalRate=" + verticalRate + ", icao24='"
		+ icao24 + '\'' + ", callsign='" + callsign + '\'' + ", onGround=" + onGround + ", lastContact="
		+ lastContact + ", lastPositionUpdate=" + lastPositionUpdate + ", originCountry='" + originCountry
		+ '\'' + ", squawk='" + squawk + '\'' + ", spi=" + spi + ", baroAltitude=" + baroAltitude
		+ ", positionSource=" + positionSource + ", serials=" + serials + '}';
    }
	...
	if (onGround != that.onGround)
	    return false;
	if (spi != that.spi)
	    return false;
	if (geoAltitude != null ? !geoAltitude.equals(that.geoAltitude) : that.geoAltitude != null)
	    return false;
	...
	if (heading != null ? !heading.equals(that.heading) : that.heading != null)
	    return false;
	if (verticalRate != null ? !verticalRate.equals(that.verticalRate) : that.verticalRate != null)
	    return false;
	if (!icao24.equals(that.icao24))
	    return false;
	if (callsign != null ? !callsign.equals(that.callsign) : that.callsign != null)
	    return false;
	if (lastContact != null ? !lastContact.equals(that.lastContact) : that.lastContact != null)
	    return false;
	if (lastPositionUpdate != null ? !lastPositionUpdate.equals(that.lastPositionUpdate)
		: that.lastPositionUpdate != null)
	    return false;
	if (originCountry != null ? !originCountry.equals(that.originCountry) : that.originCountry != null)
	    return false;
	if (squawk != null ? !squawk.equals(that.squawk) : that.squawk != null)
	    return false;
	if (baroAltitude != null ? !baroAltitude.equals(that.baroAltitude) : that.baroAltitude != null)
	    return false;
	if (positionSource != that.positionSource)
	    return false;
	...
	ADS_B, ASTERIX, MLAT, FLARM, UNKNOWN
    }
